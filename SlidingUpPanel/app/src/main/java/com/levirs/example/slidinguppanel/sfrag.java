...
public class sfrag extends Fragment implements FragmentSwipeInterface{
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            String u="http://dbms-com.stackstaging.com/solar_data.php?city="+city.name+"&code="+city.opcode;
            json_url=u;
        }
