...
public class dfrag extends Fragment implements FragmentSwipeInterface{
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            String u="http://dbms-com.stackstaging.com/demand_data.php?city="+city.name+"&code="+city.opcode;
            json_url=u;
        }
        ...
        protected void onPostExecute(String result) {
            ...
            lv = (ListView) vhold.findViewById(R.id.dlist);
            ...
            try {
                ...
                jsarray = jsobject.getJSONArray("demand");
                int count = 0;
                String t, h;
